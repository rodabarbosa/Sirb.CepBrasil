...
/// <summary>
/// Unit tests for the BrasilApiService
/// </summary>
public sealed class BrasilApiServiceTest : IDisposable
{
    ...
    /// </summary>
    [Theory(DisplayName = "Deve retornar CepContainer quando CEP é válido e existe no BrasilAPI")]
